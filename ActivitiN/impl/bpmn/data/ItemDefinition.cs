...
namespace org.activiti.engine.impl.bpmn.data
{
	...
	public class ItemDefinition
	{
	  ...
	  protected internal StructureDefinition structure;
	  ...
	  public ItemDefinition(string id, StructureDefinition structure) : this()
	  {
		this.id = id;
	  ...
	  public virtual ItemKind getItemKind()
	  {
		return itemKind;
	  }

	  public virtual void setItemKind(ItemKind itemKind)
	  {
