...
namespace org.activiti.engine.impl.bpmn.data
{
	...
	/// <summary>
	/// An instance of <seealso cref="FieldBaseStructureDefinition"/>
	/// 
	/// @author Esteban Robles Luna
	/// </summary>
	public class FieldBaseStructureInstance : StructureInstance
	{

	  protected internal FieldBaseStructureDefinition structureDefinition;
