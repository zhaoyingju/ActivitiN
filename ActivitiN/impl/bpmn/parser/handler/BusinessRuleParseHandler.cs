...
namespace org.activiti.engine.impl.bpmn.parser.handler
{
	...
	public class BusinessRuleParseHandler : AbstractActivityBpmnParseHandler<BusinessRuleTask>
	{
	  ...
	  protected internal override void executeParse(BpmnParse bpmnParse, BusinessRuleTask businessRuleTask)
	  {
		...
		activity.Async = businessRuleTask.Asynchronous;
		activity.Exclusive = !businessRuleTask.NotExclusive;
		activity.ActivityBehavior = bpmnParse.ActivityBehaviorFactory.createBusinessRuleTaskActivityBehavior(businessRuleTask);
	  }
