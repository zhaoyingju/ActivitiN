...
namespace org.activiti.engine.impl.pvm.runtime
{
	...
	/// @author Tom Baeyens
	/// </summary>
	public class AtomicOperationTransitionCreateScope : AtomicOperation
	{

	  private static Logger log = LoggerFactory.getLogger(typeof(AtomicOperationTransitionCreateScope));
	  ...
	  public virtual void execute(InterpretableExecution execution)
	  {
		...
		propagatingExecution.performOperation(AtomicOperation_Fields.TRANSITION_NOTIFY_LISTENER_START);
	  }
	}
