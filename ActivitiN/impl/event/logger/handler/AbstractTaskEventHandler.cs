...
namespace org.activiti.engine.impl.@event.logger.handler
{
	...
	public abstract class AbstractTaskEventHandler : AbstractDatabaseEventLoggerEventHandler
	{
		...
		protected internal virtual IDictionary<string, object> handleCommonTaskFields(TaskEntity task)
		{
			...
			if (task.TenantId != null && !ProcessEngineConfigurationImpl.NO_TENANT_ID.Equals(task.TenantId))
			{
