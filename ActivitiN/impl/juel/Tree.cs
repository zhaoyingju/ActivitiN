...
namespace org.activiti.engine.impl.juel
{
	...
	/// <summary>
	/// Parsed expression, usually created by a <seealso cref="org.activiti.engine.impl.juel.TreeBuilder"/>.
	/// The <seealso cref="#bind(FunctionMapper, VariableMapper)"/> method is used to create
	/// <seealso cref="org.activiti.engine.impl.juel.Bindings"/>, which are needed at evaluation time to
	...
	public class Tree
	{
		...
		public virtual Bindings bind(FunctionMapper fnMapper, VariableMapper varMapper, TypeConverter converter)
		{
			...
			if (functions.Count > 0)
			{
				...
				methods = new Method[functions.Count];
