...
namespace org.activiti.engine.impl.juel
{
	...
	using ParseException = org.activiti.engine.impl.juel.Parser.ParseException;
...
//JAVA TO C# CONVERTER WARNING: The .NET Type.FullName property will not always yield results identical to the Java Class.getName method:
			...
			{
				ELContext context = new ELContextAnonymousInnerClassHelper();
				@out.print(">> ");
				try
				{
		...
		{
			public ELContextAnonymousInnerClassHelper()
			{
			}
