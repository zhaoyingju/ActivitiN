...
namespace org.activiti.engine.impl.juel
{
	...
	/// <summary>
	/// Bindings, usually created by a <seealso cref="org.activiti.engine.impl.juel.Tree"/>.
	/// 
	...
	public class Bindings : TypeConverter
	{
		...
		private static readonly Method[] NO_FUNCTIONS = new Method[0];
		...
		private class MethodWrapper
		{
			...
			internal MethodWrapper(Method method)
			{
				this.method = method;
			}
...
//ORIGINAL LINE: private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, ClassNotFoundException
		...
		/// Constructor.
		/// </summary>
		public Bindings(Method[] functions, ValueExpression[] variables) : this(functions, variables, TypeConverter_Fields.DEFAULT)
		{
		}
		...
		/// Constructor.
		/// </summary>
		public Bindings(Method[] functions, ValueExpression[] variables, TypeConverter converter) : base()
		{
		...
		public virtual Method getFunction(int index)
		{
