...
namespace org.activiti.engine.impl.juel
{
	...
	public abstract class AstNode : ExpressionNode
	{
		...
		public abstract org.activiti.engine.impl.javax.el.MethodInfo getMethodInfo(Bindings bindings, ELContext context, Type returnType, Type[] paramTypes);
		...
		public abstract org.activiti.engine.impl.javax.el.ValueReference getValueReference(Bindings bindings, ELContext context);
