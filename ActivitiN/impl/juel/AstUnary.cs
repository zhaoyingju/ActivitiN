...
namespace org.activiti.engine.impl.juel
{
	...
	public class AstUnary : AstRightValue
	{
		...
		public static readonly Operator EMPTY = new SimpleOperatorAnonymousInnerClassHelper();
		...
		public static readonly Operator NEG = new SimpleOperatorAnonymousInnerClassHelper2();
		...
		public static readonly Operator NOT = new SimpleOperatorAnonymousInnerClassHelper3();
		...
		private class SimpleOperatorAnonymousInnerClassHelper3 : SimpleOperator
		{
			...
			public override object apply(TypeConverter converter, object o)
			{
				return !converter.convert(o, typeof(bool?));
			}
			public override string ToString()
			{
				return "!";
...
//ORIGINAL LINE: @Override public Object eval(Bindings bindings, org.activiti.engine.impl.javax.el.ELContext context) throws org.activiti.engine.impl.javax.el.ELException
