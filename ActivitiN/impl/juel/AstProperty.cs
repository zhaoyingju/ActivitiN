...
namespace org.activiti.engine.impl.juel
{
	...
	using MethodInfo = org.activiti.engine.impl.javax.el.MethodInfo;
	...
	using ValueReference = org.activiti.engine.impl.javax.el.ValueReference;
...
//ORIGINAL LINE: protected abstract Object getProperty(Bindings bindings, org.activiti.engine.impl.javax.el.ELContext context) throws org.activiti.engine.impl.javax.el.ELException;
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public boolean isReadOnly(Bindings bindings, org.activiti.engine.impl.javax.el.ELContext context) throws org.activiti.engine.impl.javax.el.ELException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void setValue(Bindings bindings, org.activiti.engine.impl.javax.el.ELContext context, Object value) throws org.activiti.engine.impl.javax.el.ELException
		...
		protected internal virtual Method findMethod(string name, Type clazz, Type returnType, Type[] paramTypes)
		{
			Method method = null;
			try
			{
		...
		public override MethodInfo getMethodInfo(Bindings bindings, ELContext context, Type returnType, Type[] paramTypes)
		{
			...
			Method method = findMethod(name, @base.GetType(), returnType, paramTypes);
