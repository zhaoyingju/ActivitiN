...
//JAVA TO C# CONVERTER TODO TASK: This Java 'import static' statement cannot be converted to .NET:
	...
	using ScanException = org.activiti.engine.impl.juel.Scanner.ScanException;
	using Symbol = org.activiti.engine.impl.juel.Scanner.Symbol;
	using Token = org.activiti.engine.impl.juel.Scanner.Token;
...
//ORIGINAL LINE: protected void fail(String expected) throws ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected void fail(org.activiti.engine.impl.juel.Scanner.Symbol expected) throws ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected final org.activiti.engine.impl.juel.Scanner.Token lookahead(int index) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected final org.activiti.engine.impl.juel.Scanner.Token consumeToken() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		protected internal Token consumeToken()
		{
			...
			{
				LookaheadToken next = lookahead_Renamed.Remove(0);
				token = next.token;
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected final org.activiti.engine.impl.juel.Scanner.Token consumeToken(org.activiti.engine.impl.juel.Scanner.Symbol expected) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Tree tree() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode text() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstEval eval() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstEval eval(boolean required, boolean deferred) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode expr(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode or(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode and(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode eq(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode cmp(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode add(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode mul(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode unary(boolean required) throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode value() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode nonliteral() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		protected internal virtual AstNode nonliteral()
		{
			...
			switch (token.Symbol)
			{
				case IDENTIFIER:
					...
					if (token.Symbol == COLON && lookahead(0).Symbol == IDENTIFIER && lookahead(1).Symbol == LPAREN) // ns:f(...)
					{
						consumeToken();
						name += ":" + token.Image;
						consumeToken();
					}
					if (token.Symbol == LPAREN) // function
					{
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstParameters params() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
		...
		/// </summary>
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: protected AstNode literal() throws org.activiti.engine.impl.juel.Scanner.ScanException, ParseException
