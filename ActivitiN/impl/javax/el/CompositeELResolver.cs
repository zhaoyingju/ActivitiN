...
//ORIGINAL LINE: @Override public java.util.Iterator<java.beans.FeatureDescriptor> getFeatureDescriptors(final ELContext context, final Object base)
		public override IEnumerator<FeatureDescriptor> getFeatureDescriptors(ELContext context, object @base)
		{
			return new IteratorAnonymousInnerClassHelper(this, context, @base);
		}
		...
		private class IteratorAnonymousInnerClassHelper : IEnumerator<FeatureDescriptor>
		{
			...
			private org.activiti.engine.impl.javax.el.ELContext context;
			private object @base;

			public IteratorAnonymousInnerClassHelper(CompositeELResolver outerInstance, org.activiti.engine.impl.javax.el.ELContext context, object @base)
			{
				this.outerInstance = outerInstance;
				this.context = context;
				this.@base = @base;
				empty = Collections.emptyList<FeatureDescriptor> ().GetEnumerator();
			...
			internal virtual IEnumerator<FeatureDescriptor> features()
			{
