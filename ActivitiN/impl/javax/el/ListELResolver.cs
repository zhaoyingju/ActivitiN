...
//ORIGINAL LINE: toIndex((java.util.List<?>) base, property);
				toIndex((IList<?>) @base, property);
...
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: java.util.List<?> list = (java.util.List<?>) base;
...
//ORIGINAL LINE: @Override @SuppressWarnings("unchecked") public void setValue(ELContext context, Object base, Object property, Object value)
		...
		{
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: return base instanceof java.util.List<?>;
			return @base is IList<?>;
		}
		...
		private static int toIndex<T1>(IList<T1> @base, object property)
		{
			...
			{
				index = (char)((char?) property);
			}
			else if (property is bool?)
			{
				index = (bool)((bool?) property) ? 1 : 0;
			}
			else
			{
