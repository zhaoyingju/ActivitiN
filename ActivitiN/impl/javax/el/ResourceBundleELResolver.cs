...
//ORIGINAL LINE: final java.util.Iterator<String> keys = ((java.util.ResourceBundle) base).getKeys();
		...
		private class IteratorAnonymousInnerClassHelper : IEnumerator<FeatureDescriptor>
		{
			...
			public IteratorAnonymousInnerClassHelper(ResourceBundleELResolver outerInstance, IEnumerator<string> keys)
			{
