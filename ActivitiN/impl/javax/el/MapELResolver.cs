...
//ORIGINAL LINE: java.util.Map<?, ?> map = (java.util.Map<?, ?>) base;
				IDictionary<?, ?> map = (IDictionary<?, ?>) @base;
...
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: private IEnumerator<JavaToDotNetGenericWildcard> keys;
			private IEnumerator<?> keys;

			public IteratorAnonymousInnerClassHelper<T1>(MapELResolver outerInstance, IEnumerator<T1> keys)
			{
...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
		...
		public override object getValue(ELContext context, object @base, object property)
		{
			...
			{
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: result = ((java.util.Map<?, ?>) base).get(property);
				result = ((IDictionary<?, ?>) @base)[property];
				context.PropertyResolved = true;
			}
			return result;
		}
...
//ORIGINAL LINE: @Override @SuppressWarnings("unchecked") public void setValue(ELContext context, Object base, Object property, Object value)
		...
		{
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: return base instanceof java.util.Map<?,?>;
			return @base is IDictionary<?, ?>;
		}
	}
