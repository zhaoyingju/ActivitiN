...
namespace org.activiti.engine.impl.db.upgrade
{
	...
	/// @author Tom Baeyens
	/// </summary>
	public class DbUpgradeStep52To53InsertPropertyHistoryLevel : DbUpgradeStep
	{

//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public void execute(org.activiti.engine.impl.db.DbSqlSession dbSqlSession) throws Exception
	  public virtual void execute(DbSqlSession dbSqlSession)
	  {
