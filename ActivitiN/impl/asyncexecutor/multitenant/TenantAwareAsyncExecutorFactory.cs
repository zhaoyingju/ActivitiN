...
namespace org.activiti.engine.impl.asyncexecutor.multitenant
{
	...
	/// This factory will be called when a new <seealso cref="AsyncExecutor"/> for a tenant needs to be created
	...
	public interface TenantAwareAsyncExecutorFactory
	{
	  ...
	  /// <summary>
	  /// Allows to create an <seealso cref="AsyncExecutor"/> specifically for a tenant. 
	  /// </summary>
