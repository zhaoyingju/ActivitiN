...
namespace org.activiti.engine.impl.jobexecutor
{
	...
	/// @author Joram Barrez
	/// </summary>
	public class SingleJobExecutorContext : JobExecutorContext
	{

	  protected internal IList<JobEntity> currentProcessorJobQueue = new LinkedList<JobEntity>();
	  protected internal JobEntity currentJob;

	  public virtual IList<JobEntity> CurrentProcessorJobQueue
	  {
		  get
		  {
