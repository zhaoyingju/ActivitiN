...
namespace org.activiti.engine.impl.cmd
{
	...
	/// </summary>
	[Serializable]
	public class CreateGroupCmd : Command<Group>
	{
	  ...
	  public virtual Group execute(CommandContext commandContext)
	  {
		return commandContext.GroupIdentityManager.createNewGroup(groupId);
	  }
