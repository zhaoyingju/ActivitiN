...
namespace org.activiti.engine.impl.scripting
{
	...
	public class ScriptingEngines
	{
	  ...
	  public virtual object evaluate(string script, string language, VariableScope variableScope)
	  {
		return evaluate(script, language, createBindings(variableScope));
	  }

	  public virtual object evaluate(string script, string language, VariableScope variableScope, bool storeScriptVariables)
	  {
	  ...
	  protected internal virtual Bindings createBindings(VariableScope variableScope)
	  {
	  ...
	  /// <summary>
	  /// override to build a spring aware ScriptingEngines </summary>
	  protected internal virtual Bindings createBindings(VariableScope variableScope, bool storeScriptVariables)
	  {
