...
namespace org.activiti.engine.impl.scripting
{
	...
	using ExpressionFactoryResolver = org.activiti.engine.impl.el.ExpressionFactoryResolver;
	...
	using SimpleResolver = org.activiti.engine.impl.juel.SimpleResolver;
...
//ORIGINAL LINE: public javax.script.CompiledScript compile(String script) throws javax.script.ScriptException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public javax.script.CompiledScript compile(java.io.Reader reader) throws javax.script.ScriptException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private Object evaluateExpression(org.activiti.engine.impl.javax.el.ValueExpression expr, javax.script.ScriptContext ctx) throws javax.script.ScriptException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private org.activiti.engine.impl.javax.el.ValueExpression parse(String script, javax.script.ScriptContext scriptContext) throws javax.script.ScriptException
...
//ORIGINAL LINE: private org.activiti.engine.impl.javax.el.ELContext createElContext(final javax.script.ScriptContext scriptCtx)
	  ...
	  private class ELContextAnonymousInnerClassHelper : ELContext
	  {
		  ...
		  public ELContextAnonymousInnerClassHelper(JuelScriptEngine outerInstance, ScriptContext scriptCtx)
		  {
