...
namespace org.activiti.engine.impl.persistence
{
	...
	using UserEntityManager = org.activiti.engine.impl.persistence.entity.UserEntityManager;
	...
	/// @author Joram Barrez
	/// </summary>
	public class UserEntityManagerFactory : SessionFactory
	{
	  ...
	  public virtual Type SessionType
	  {
		  get
		  {
			return typeof(UserIdentityManager);
		  }
	  }
