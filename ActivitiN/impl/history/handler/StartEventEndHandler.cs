...
namespace org.activiti.engine.impl.history.handler
{
	...
	/// </summary>
	[Serializable]
	public class StartEventEndHandler : ExecutionListener
	{
...
//ORIGINAL LINE: public void notify(org.activiti.engine.delegate.DelegateExecution execution) throws Exception
	  ...
	  {
		string activityId = ((ExecutionEntity) execution).ActivityId;

		Context.CommandContext.HistoryManager.recordStartEventEnded((ExecutionEntity) execution, activityId);
	  }
