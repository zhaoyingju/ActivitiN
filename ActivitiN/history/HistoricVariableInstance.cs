...
namespace org.activiti.engine.history
{
	...
	/// @author ruecker
	/// </summary>
	public interface HistoricVariableInstance : HistoricData
	{
	  ...
	  /// <returns> the task id of the task, in case this variable instance has been set locally
	  /// on a task. Returns null, if this variable is not related to a task. </returns>
	  string TaskId {get;}
	  ...
	  /// Note that a <seealso cref="HistoricVariableInstance"/> only contains the latest value
	  /// of the variable. The actual different value and value changes are recorded in
	  /// <seealso cref="HistoricVariableUpdate"/> instances, which are captured on <seealso cref="HistoryLevel"/> FULL.
	  /// </summary>
