...
namespace org.activiti.engine.task
{
	...
	/// </summary>
	public interface TaskQuery : TaskInfoQuery<TaskQuery, Task>
	{
	  ...
	  ///  You can invoke <seealso cref="#taskCandidateGroupIn(List)"/> to include tasks that can be claimed by a user in the given groups
