...
namespace org.activiti.engine.task
{
	...
	/// <summary>
	/// Interface containing shared methods between the <seealso cref="TaskQuery"/> and the <seealso cref="HistoricTaskInstanceQuery"/>.
	/// 
	/// @author Joram Barrez
	/// </summary>
//JAVA TO C# CONVERTER TODO TASK: Java wildcard generics are not converted to .NET:
//ORIGINAL LINE: public interface TaskInfoQuery<T extends TaskInfoQuery<?, ?>, V extends TaskInfo> extends org.activiti.engine.query.Query<T, V>
	public interface TaskInfoQuery<T, V> : Query<T, V> where T : TaskInfoQuery<?, ?> where V : TaskInfo
	{
	  ...
	  /// Only select tasks with a name that is in the given list
	  /// 
	  /// This method, unlike the <seealso cref="#taskNameIn(List)"/> method will
	  ...
	  ///  The syntax is that of SQL: for example usage: nameLike(%activiti%)
	  ///  
	  ///  This method, unlike the <seealso cref="#taskNameLike(String)"/> method will 
	  ...
	  ///  The syntax is that of SQL: for example usage: descriptionLike(%activiti%)
	  ///  
	  ///  This method, unlike the <seealso cref="#taskDescriptionLike(String)"/> method will 
	  ///  not take in account the upper/lower case: both the input parameter as the column value are
	  ///  lowercased when the query is executed. 
	  /// </summary>
	  ...
	  /// The syntax that should be used is the same as in SQL, eg. %activiti%.
	  /// 
	  /// This method, unlike the <seealso cref="#taskAssigneeLike(String)"/> method will 
	  /// not take in account the upper/lower case: both the input parameter as the column value are
	  /// lowercased when the query is executed. 
	  /// </summary>
	  ...
	  /// The syntax that should be used is the same as in SQL, eg. %activiti%.
	  /// 
	  /// This method, unlike the <seealso cref="#taskOwnerLike(String)"/> method will 
	  /// not take in account the upper/lower case: both the input parameter as the column value are
	  /// lowercased when the query is executed. 
	  /// </summary>
	  ...
	  /// <summary>
	  /// Only select tasks for which there exist an <seealso cref="IdentityLink"/> with the given user, including tasks which have been 
	  ...
	  /// </summary>
	  /// <exception cref="ActivitiIllegalArgumentException"> 
	  ///   When query is executed and <seealso cref="#taskCandidateGroup(String)"/> or 
	  ///     <seealso cref="#taskCandidateUser(String)"/> has been executed on the query instance. 
	  ///   When passed group list is empty or <code>null</code>.  </exception>
	  ...
	  /// The syntax is that of SQL: for example usage: processInstanceBusinessKeyLike("%activiti%"). 
	  /// 
	  /// This method, unlike the <seealso cref="#processInstanceBusinessKeyLike(String)"/> method will 
	  /// not take in account the upper/lower case: both the input parameter as the column value are
	  /// lowercased when the query is executed. 
	  /// </summary>
	  ...
	  /// The syntax that should be used is the same as in SQL, eg. %activiti%.
	  /// 
	  /// This method, unlike the <seealso cref="#processDefinitionKeyLike(String)"/> method will 
	  ///  not take in account the upper/lower case: both the input parameter as the column value are
	  ///  lowercased when the query is executed.
	  /// </summary>
	  ...
	  /// <summary>
	  /// Order by description (needs to be followed by <seealso cref="#asc()"/> or <seealso cref="#desc()"/>). </summary>
	  T orderByTaskDescription();

	  /// <summary>
	  /// Order by priority (needs to be followed by <seealso cref="#asc()"/> or <seealso cref="#desc()"/>). </summary>
	  T orderByTaskPriority();

	  /// <summary>
	  /// Order by assignee (needs to be followed by <seealso cref="#asc()"/> or <seealso cref="#desc()"/>). </summary>
	  T orderByTaskAssignee();

	  /// <summary>
	  /// Order by the time on which the tasks were created (needs to be followed by <seealso cref="#asc()"/> or <seealso cref="#desc()"/>). </summary>
