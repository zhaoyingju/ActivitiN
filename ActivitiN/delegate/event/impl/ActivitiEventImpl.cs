...
namespace org.activiti.engine.@delegate.@event.impl
{
	...
	/// <summary>
	/// Base class for all <seealso cref="ActivitiEvent"/> implementations.
	/// 
	/// @author Frederik Heremans
	/// </summary>
	public class ActivitiEventImpl : ActivitiEvent
	{
		...
		public override EngineServices EngineServices
		{
			get
			{
