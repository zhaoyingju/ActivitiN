...
namespace org.activiti.engine.@delegate
{
    ...
    public interface DelegateTask : VariableScope
    {
        ...
        /// <summary>
        /// The current <seealso cref="org.activiti.engine.task.DelegationState"/> for this task. </summary>
        ...
        /// <summary>
        /// The category of the task. This is an optional field and allows to 'tag' tasks as belonging to a certain category. </summary>
        ...
        List<IdentityLink> Candidates { get; }
    }
