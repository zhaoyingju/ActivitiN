...
namespace org.activiti.bpmn.constants
{
    public class BpmnXMLConstants
    {
        ...
        public static string PROCESS_NAMESPACE = "http://www.activiti.org/test";
        ...
        public static string ELEMENT_CALL_ACTIVITY_IN_PARAMETERS = "in";
        public static string ELEMENT_CALL_ACTIVITY_OUT_PARAMETERS = "out";
